...
class BeersViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let resource = ImageResource(downloadURL: URL(string: beer.image_url)!)
        
        cell.imgCell.kf.setImage(with: resource)
        cell.imgCell.contentMode = UIViewContentMode.scaleAspectFit
        
        cell.nameCell.text = beer.name
        cell.descCell.text = "Teor alcoólico: \(beer.abv)"
